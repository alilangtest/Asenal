...
extern Status GetBufferParse(const int32_t opcode, const char *rbuf, const int32_t rbuf_len, std::string *value);
extern Status SetBufferParse(const int32_t opcode, const char *rbuf, const int32_t rbuf_len);
